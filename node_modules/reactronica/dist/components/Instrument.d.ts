...
export declare type InstrumentType = 'amSynth' | 'duoSynth' | 'fmSynth' | 'membraneSynth' | 'metalSynth' | 'monoSynth' | 'noiseSynth' | 'pluckSynth' | 'synth' | 'sampler';
...
declare const Instrument: React.FC<InstrumentProps>;
